    ...
    <div className="bg-white my-8 rounded-md h-100 ">
      <form className="h-full w-[80%] grid items-center grid-cols-2 p-2 gap-4">
        ...
        <input
          ...
          onBlur={(e) =>
            mutate({ ...settings, minBookingLength: e.target.value })
          }
        />
        ...
        <input
          ...
          onBlur={(e) =>
            mutate({ ...settings, maxBookingLength: e.target.value })
          }
        />
        ...
        <input
          ...
          onBlur={(e) =>
            mutate({ ...settings, maxGuestsPerBooking: e.target.value })
          }
        />
        ...
        <input
          ...
          onBlur={(e) =>
            mutate({ ...settings, breakfastPrice: e.target.value })
          }
        />
      </form>
    </div>
